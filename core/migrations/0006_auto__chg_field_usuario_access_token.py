...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Usuario.access_token'
        db.alter_column(u'core_usuario', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Usuario.access_token'
        db.alter_column(u'core_usuario', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=200))
