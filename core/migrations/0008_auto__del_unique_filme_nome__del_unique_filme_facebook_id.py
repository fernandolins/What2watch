...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Filme', fields ['facebook_id']
        db.delete_unique(u'core_filme', ['facebook_id'])

        # Removing unique constraint on 'Filme', fields ['nome']
        db.delete_unique(u'core_filme', ['nome'])


    def backwards(self, orm):
        # Adding unique constraint on 'Filme', fields ['nome']
        db.create_unique(u'core_filme', ['nome'])

        # Adding unique constraint on 'Filme', fields ['facebook_id']
        db.create_unique(u'core_filme', ['facebook_id'])
    ...
    models = {
        ...
        u'core.filme': {
            ...
            'facebook_id': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            ...
            'link_foto': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
