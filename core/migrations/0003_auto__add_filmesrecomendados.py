...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilmesRecomendados'
        db.create_table(u'core_filmesrecomendados', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Usuario'])),
            ('filme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Filme'])),
            ('score', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'core', ['FilmesRecomendados'])


    def backwards(self, orm):
        # Deleting model 'FilmesRecomendados'
        db.delete_table(u'core_filmesrecomendados')
